...
export class ForumComponent implements OnInit, OnDestroy {
  ...
  // getData() {
  //   this.mockService.getAll().subscribe(
  //     (res) => {
  //       // Success
  //       this.tableRows = [...res];
  ...
  openModalBesor(modalRef: TemplateRef<any>) {
    // if (row) {
    //   console.log(row);
    //   this.editActionForm.patchValue(row);
    // }
  ...
  getChart() {
    let chart = am4core.create("chartUserPay", am4charts.XYChart);
