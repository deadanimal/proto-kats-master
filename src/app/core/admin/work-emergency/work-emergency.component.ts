...
@Component({
  selector: "app-work-emergency",
  templateUrl: "./work-emergency.component.html",
  styleUrls: ["./work-emergency.component.scss"],
})
export class WorkEmergencyComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    let chart = am4core.create("chartdivRcm", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivRcm2", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivBillDelivery4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillDelivery5", am4charts.XYChart);
    chart.colors.step = 2;
